...
from logsec.exceptions import LogsecError, ConfigError, ParseError
...
def safe_execute(func):
    def wrapper(*args, **kwargs):
        try:
            ...
            raise LogsecError(f"Failed to execute {func.__name__}: {e}") from e
    return wrapper
...
@safe_execute
def configure_geoip(enabled=None, provider=None, cache_days=None, timeout_seconds=None):
    # Your existing code here...
    pass

@safe_execute
def analyze_apache_file(logfile, login_url="/login", bf_threshold=3, risk_score_min=None, mitre=False, include_internal=False):
    # Your existing code here...
    pass

@safe_execute
def monitor_log(log_path, login_url="/login", dashboard=False, dashboard_refresh=3.0):
    # Your existing code here...
    pass

@safe_execute
def analyze_juice_logs(logfile):
    # Your existing code here...
    pass
